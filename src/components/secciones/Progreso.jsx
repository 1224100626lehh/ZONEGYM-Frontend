...
export default function MiProgreso() {
  ...
  const handleAgendar = async () => {
    // DEMO: solo alerta
    alert(
      "Demo: aquí después se abrirá agenda.",
    );
    // BACKEND:
        ...
        <div style={styles.cards}>
          ...
          >
            ...
            <p style={styles.cardText}>
              2 semanas seguidas cumpliendo 4 días. Eso crea hábito real.
            </p>
          </motion.div>
          ...
          >
            ...
            <p style={styles.cardText}>
              “No fallé dos tres dias seguidos” desbloqueado{" "}
          ...
          >
            ...
            <p style={styles.cardText}>
              Agenda tus 3 días de la próxima semana.
            </p>
          </motion.div>
        </div>
      </motion.div>
