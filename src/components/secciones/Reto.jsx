...
export default function Reto() {
  ...
  const onDescuento = () => {
    if (pct < 100) {
      showToast("🎯 Completa el reto para desbloquear el beneficio");
      return;
    }
    showToast("🎁 Beneficio aplicado: descuento/regalo ");
    // Backend futuro:
    ...
    <AnimatePresence mode="wait">
      ...
      >
        <div style={{ width: "min(1100px, 92%)", margin: "0 auto" }}>
          ...
          >
           <FaFire color="orange" size={36} />
           <span style={{ color: "white", fontSize: "18px" }}>
            ¡No dejes que tu racha se apage, como se apago tu relacin!
           </span>
          </motion.div>
